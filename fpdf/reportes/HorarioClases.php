...
$CodigoGrupoFinal= $_GET['CodigoGrupoFinal'];
$datos= $_GET['datosGrupo'];
$G= $_GET['yearG'];
$guia= $_GET['DocenteGuia'];
$sql = "call SP_HorarioAsignatura($CodigoGrupoFinal);";
...
{
    // Logo
    $this->Image('h.jpg',0,0,300,0,'JPG');
    ...
    $this->Cell(250,7,utf8_decode("Fecha y Hora de Impresion: ". $fecha_actual),0,1,'R',0);
    ...
    $this->Cell(30);
    // Título
    $this->Cell(220,10,utf8_decode('Sistema de Control y Planificación Académica'),1,0,'C');
    // Salto de línea
    $this->Ln(50);
}
...
$pdf->SetTextColor(255,255,255);
    ...
    $pdf->Cell(220,9,utf8_decode('Horario de Clases: '.$datos."       Año Electivo ".$G),1,1,'C',1);
    $pdf->Ln(3);

    $pdf->SetTextColor(255,255,255);
    $pdf->SetFont('Arial','B',12);
    $pdf->SetFillColor(18,61,192);
    $pdf->Cell(24,7,utf8_decode('Bloque'),1,0,'C',1);
    $pdf->Cell(50,7,utf8_decode('Lunes'),1,0,'C',1);
    $pdf->Cell(50,7,utf8_decode('Martes'),1,0,'C',1);
    $pdf->Cell(50,7,utf8_decode('Miercoles'),1,0,'C',1);
    $pdf->Cell(50,7,utf8_decode('Jueves'),1,0,'C',1);
    $pdf->Cell(50,7,utf8_decode('Viernes'),1,1,'C',1);
...
foreach($horario as $hora => $dias) {
    ...
    $pdf->Cell(24,9,utf8_decode($hora),1,0,'C',1);
    $pdf->Cell(50,9,utf8_decode($dias['LUNES']),1,0,'C',1);
    $pdf->Cell(50,9,utf8_decode($dias['MARTES']),1,0,'C',1);
    $pdf->Cell(50,9,utf8_decode($dias['MIERCOLES']),1,0,'C',1);
    $pdf->Cell(50,9,utf8_decode($dias['JUEVES']),1,0,'C',1);
    $pdf->Cell(50,9,utf8_decode($dias['VIERNES']),1,1,'C',1);
    $pdf->Ln(1);
}
...
$pdf->SetTextColor(255,255,255);
    ...
    $pdf->SetFillColor(47,59,84);
    $pdf->Cell(130,9,utf8_decode('Docente Guia: '.$guia),1,1,'C',1);
