...
<html lang="es">
<head>
    <title>Modalidades y Grados</title>
<?php
   ...
   <form class="form-card needs-validation" novalidate onsubmit="event.preventDefault()">
                    <div class="row mt-4">
                        <div class="text-center">
                            <h2 class="letra_fondo"> <i class="bi bi-pencil-square"></i> Designación de Grados en Modalidades </h2>
                        </div>
                    </div>
                    <hr>
    ...
    <div class="row">
        ...
        <button class="btn fondo_degradado_azul text-light" data-bs-toggle="modal" data-bs-target="#modal-agregar">
                    Designar Grado <i class="bi bi-pencil-square"></i>
                    </button>
        </div>
        <!-- <div class="col-5">
    ...
    <div class="table-responsive mt-4" id="tabla_grado">
    </div>
...
<script text="text/javascript">
    ...
    $('#tabla_grado').load('../componentes/tabla_grado_modalidad.php');
    });
