   ...
   <form class="form-card needs-validation" novalidate onsubmit="event.preventDefault()">
                    <div class="row mt-4">
                        <div class="text-center">
                            <h2 class="letra_fondo"> <i class="bi bi-pencil-square"></i> Registro de Asignaturas </h2>
                        </div>
                    </div>
                    <hr>
                    <caption>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body"> 
                    <div class="form-floating mb-3">
                        <input type="text" name="p_nombre" id="asignatura" class="form-control fondo_azul" placeholder="Asignatura" minlength="0" maxlength="35" required>
                        <label for="floatingInput" class="fondo_azul">Asignatura</label>
                    </div>
                </div>
...
<form id="form_actualizar" >
    <div class="modal fade" id="modal-editar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 letra_fondo" id="exampleModalLabel">  <i class="bi bi-pencil-square"></i> Actualizar Asignatura </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                 </div>
                 <div class="modal-body"> 
                    <div class="form-floating mb-3">
                ...
                <div class="modal-body"> 
                    <div class="form-floating mb-3">
                        <input type="text"  id="asigu" class="form-control fondo_azul" placeholder="" minlength="0" maxlength="35" required>
                        <label for="floatingInput" class="fondo_azul">ASIGNATURA</label>
                    </div>
                </div>
                <div class="modal-footer">
